...
class RatingBook(FlaskForm):
    book = SelectField('ID книги', coerce=int)
    rating = SelectField('Оценка по шкале', coerce=int, choices=[(0, "Не решаюсь ответить"), (1, "Абсолютно не понравилось"), (2, "Не понравилось"), (3, "Нейтрально"), (4, "Понравилось"), (5, "Очень понравилось")])
